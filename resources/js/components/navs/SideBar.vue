<template>
    <aside
        id="logo-sidebar"
        class="w-full h-full pt-14 transition-transform -translate-x-full bg-blue-900 border-r border-gray-200 sm:translate-x-0"
        aria-label="Sidebar"
    >
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <RouterLink to="/users">
                        ...
                        >
                            <FontAwesomeIcon
                                class="text-gray-400 text-lg group-hover:text-white"
                                :icon="faUsers"
                            />
                            <span class="flex-1 ms-3 whitespace-nowrap"
                                >Users</span
